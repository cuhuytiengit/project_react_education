...
var NodeTitle = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        popoverContent && (react_1.default.createElement(antd_1.Popover, { placement: "right", destroyTooltipOnHide: true, content: popoverContent, visible: isVisible, onVisibleChange: function (val) {
            ...
            react_1.default.createElement("div", { className: prefixClz + "-node-wrapper", onMouseEnter: function () {
                    setVisible(true);
        ...
        !popoverContent && (react_1.default.createElement("div", { className: prefixClz + "-node-wrapper", onMouseEnter: function () {
                setVisible(true);
            } }, (0, exports.renderNode)({
            graphConfig: graphConfig,
            commandService: commandService,
...
var NodePanelBody = function (props) {
    ...
    var renderTree = react_1.default.useCallback(function (treeList) {
        ...
        return treeList.map(function (item) {
            ...
            if (isDirectory) {
                return (react_1.default.createElement(TreeNode, { icon: FolderIcon, key: item.id, title: item.label, className: prefixClz + "-tree-folder" }, renderTree(children)));
            }
            return (react_1.default.createElement(TreeNode, { isLeaf: true, key: item.id, className: prefixClz + "-tree-leaf", icon: react_1.default.createElement("span", null), title: react_1.default.createElement(exports.NodeTitle, { item: item, onMouseDown: onMouseDown(item), popoverContent: popoverContent, prefixClz: prefixClz, modelService: modelService, commandService: commandService, graphConfig: graphConfig }) }));
        });
    }, [commandService, graphConfig, modelService, onMouseDown, prefixClz]);
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: prefixClz + "-body", style: props.style },
            !state.keyword && (react_1.default.createElement(DirectoryTree, { showIcon: true, selectable: false, autoExpandParent: false, onExpand: onFolderExpand, expandedKeys: state.expandedKeys, className: prefixClz + "-tree" }, renderTree(state.treeData))),
            state.searchList.length > 0 && (react_1.default.createElement("ul", { className: prefixClz + "-body-list" }, state.searchList.map(function (treeNode) { return (react_1.default.createElement("li", { className: prefixClz + "-body-list-item" },
