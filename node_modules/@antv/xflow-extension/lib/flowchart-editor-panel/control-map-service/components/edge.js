...
var EdgeComponent = function (props) {
    ...
    var _b = (0, react_1.useState)(__assign(__assign({}, constants_1.DefaultEdgeConfig), config)), edgeConfig = _b[0], setEdgeConfig = _b[1];
    (0, react_1.useEffect)(function () {
        setEdgeConfig(__assign(__assign({}, constants_1.DefaultEdgeConfig), config));
    }, [config]);
    ...
    return (react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-body" },
        react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-group" },
        ...
        react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-group", style: { marginBottom: 0 } },
            ...
            react_1.default.createElement("div", { className: constants_1.PREFIX + "-edge-stroke-style" },
        ...
        react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-group" },
            ...
            react_1.default.createElement("div", { className: constants_1.PREFIX + "-edge-text-style" },
...
var EdgeService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, __assign({}, props, { type: "edge" }), function (config, plugin) { return react_1.default.createElement(EdgeComponent, __assign({}, props, { plugin: plugin, config: config })); }));
};
