...
var GroupComponent = function (props) {
    ...
    var _b = (0, react_1.useState)(__assign(__assign({}, flowchart_node_panel_1.DefaultNodeConfig), config)), groupConfig = _b[0], setGroupConfig = _b[1];
    ...
    (0, react_1.useEffect)(function () {
        setGroupConfig(__assign(__assign({}, flowchart_node_panel_1.DefaultNodeConfig), config));
    }, [config]);
    return (react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-body" },
        ...
        react_1.default.createElement("div", { className: constants_1.PREFIX + "-panel-group" },
            ...
            react_1.default.createElement("div", { className: constants_1.PREFIX + "-node-text-style" },
...
var GroupService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, __assign({}, props), function (config, plugin) { return react_1.default.createElement(GroupComponent, __assign({}, props, { plugin: plugin, config: config })); }));
};
