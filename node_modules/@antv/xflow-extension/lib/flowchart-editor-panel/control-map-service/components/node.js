...
var NodeComponent = function (props) {
    ...
    var _b = (0, react_1.useState)(__assign(__assign({}, flowchart_node_panel_1.DefaultNodeConfig), config)), nodeConfig = _b[0], setNodeConfig = _b[1];
    ...
    (0, react_1.useEffect)(function () {
        setNodeConfig(__assign(__assign({}, flowchart_node_panel_1.DefaultNodeConfig), config));
    }, [config]);
...
var NodeService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, __assign({}, props), function (config, plugin) { return react_1.default.createElement(NodeComponent, __assign({}, props, { plugin: plugin, config: config })); }));
};
