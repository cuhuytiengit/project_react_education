...
(function (ErrorUtils) {
    ...
    var HookError = /** @class */ (function (_super) {
        ...
        function HookError(code, message) {
            ...
            _this = _super.call(this, code + ": " + message) || this;
    ...
    var createError = function (code, message) {
        ...
        return new (HookError.bind.apply(HookError, __spreadArray([void 0, code, message], args, false)))();
    };
...
(function (HookUtils) {
    ...
    HookUtils.normalize = function (hookConfig, hookMap) {
        ...
        return __spreadArray(__spreadArray([], innerHooks, true), runtimeHook, true).filter(function (item) { return item && !!item.handler; });
    };
    /** 排序 hooks */
